    ...
    <>
      ...
      <Modal isOpen={isModalOpen} onClose={() => closeModal(false)}>
        ...
        <ModalBody>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Bradford Chess Centre Limited, 8
                Crescent Court.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to The Chess Centre, accessible
                from{" "}
                <a
          ...
          <ul>
            <li>
              <p>By email: info@chesscentre.online</p>
            </li>
            <li>
              <p>By phone number: 01943 725101</p>
            </li>
          </ul>
          </div>
        </ModalBody>
