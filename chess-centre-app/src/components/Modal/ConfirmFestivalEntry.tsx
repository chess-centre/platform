                            ...
                            <Dialog.Panel className="relative bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-sm sm:w-full sm:p-6">
                                <div>
                                    <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-yellow-100">
                                        <span className="text-lg"><i className="fas fa-badge-check text-yellow-500"></i></span>
                                    </div>
                                                ...
                                                <table className="min-w-full divide-y divide-gray-300">
                                                    <tbody className="divide-y divide-gray-200 bg-white">
                                                        <tr>
                                                            ...
                                                            <td className="whitespace-nowrap px-3 py-4 text-md text-yellow-400 text-left">{section}</td>
                                                        </tr>
                                                        <tr>
                                                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">Bye Rounds</td>
                                                            <td className="whitespace-nowrap px-3 py-4 text-md text-yellow-400 text-left">
                                ...
                                <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                                    <Link
                                        to={url}
                                        className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-yellow-500 text-base font-medium text-white hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400 sm:col-start-2 sm:text-sm"
                                    >
                                        Continue
                                    </Link>
                                    <button
                                        type="button"
                                        className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400 sm:mt-0 sm:col-start-1 sm:text-sm"
