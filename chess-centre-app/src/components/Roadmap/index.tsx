  ...
  return (
    <div>
      <div className="relative bg-gray-50 overflow-hidden">
        <div className="relative pt-6 pb-6 sm:pb-6 md:pb-6 lg:pb-6 xl:pb-6 z-50">
          <LandingNav />
        </div>
        <div className="bg-white z-10">
          <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-base max-w-xl mt-5 mx-auto sm:text-xl text-gray-500">
                Checkout the things we're working on and get involved with the
                ideas to help us continually make things better!
              </p>
            </div>
          </div>
        </div>
