const Refreshments = () => {
  return (
    <div className="prose prose-yellow text-gray-500 mx-auto lg:max-w-none text-justify">
      ...
      <p className="prose prose-yellow text-gray-500">
...
const Facilities = ({ openingTime = "9:30am Saturday Morning" }) => {
  return (
    <div className="mt-2 prose prose-yellow text-gray-500 mx-auto lg:max-w-none text-justify">
      <h3>Facilities</h3>
      <p className="prose prose-yellow text-gray-500">
        <i className="fad fa-wheelchair text-yellow-400"></i> We apologise, our
