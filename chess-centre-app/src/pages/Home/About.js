                  ...
                  <div className="space-y-4">
                    ...
                    <div className="text-lg text-justify text-gray-500 mb-2">
                      <p className="mb-2">
                        ...
                        Yorkshire Open team on top board, winning three county championships.
                      </p>
                      <p className="mb-2">
                        When not building our digital Chess Centre experience,
                        Matt is a Lead Engineer working for a Leading Global Investment
                        Bank. He enjoys spending time with his Nieces &#38; Nephews and also 
