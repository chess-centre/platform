...
const LandingPage = () => {
    return (<div class="relative bg-gray-50 overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
        <nav className="relative flex items-center justify-between sm:h-10 md:justify-center">
          ...
          <div className="hidden md:flex md:space-x-10">
           ...
           <Link className="font-medium text-gray-500 hover:text-orange-400 transition duration-150 ease-in-out" to="/our-mission">Membership</Link>
        ...
        <div className="rounded-lg shadow-md">
          <div className="rounded-lg bg-white shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
            ...
            <div className="px-2 pt-2 pb-3">
              ...
              <Link className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out" role="menuitem" to="/membership">Membership</Link>
