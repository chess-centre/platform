        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-centre">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Chess can be played in all kinds of ways, from long play 😴 to
              bullet 🔥 and from two players 🤼 to four 😲! The important thing
              is to have fun and to enjoy the challenge.
            </p>
          </div>
