  ...
  <div className="max-w-max lg:max-w-7xl mx-auto">
    <div className="relative z-10 mb-8 md:mb-2 md:px-6">
      <div className="text-base max-w-prose lg:max-w-none">
        ...
        <h2 className="leading-6 text-teal-600 font-semibold tracking-wide uppercase">Our Mission</h2>
        <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Make Chess Great Again</p>
      </div>
    </div>
    <div className="relative">
      ...
      <div className="relative md:bg-white md:p-6">
        ...
        <div className="mt-8 inline-flex rounded-md shadow">
          <a href="/membership" className="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700">
            Join us
          </a>
        </div>
      </div>
