...
function Members() {
  ...
  return (
    <div>
      {showSneakPeek ? (
        <div>
          <div className="hidden sm:block relative mt-10 mx-20">
            <div className="mb-4 h-full">
              <h3 className="text-center text-3xl font-extrabold  text-gray-900 sm:text-4xl mb-4">
                Our game viewer
              </h3>
              {/* WEB SPECIFIC */}
              <div className=" bg-white shadow overflow-auto rounded-lg p-4 mt-5">
                <PGNViewer layout={"left"} size="400">
                  {games[0].pgn}
                </PGNViewer>
                <div
          ...
          <div className="block sm:hidden relative">
            <div className="mb-4 h-full mt-4">
              ...
              <div className="bg-white shadow overflow-auto p-2 mx-auto content-center">
                ...
                <div className="divide-y divide-gray-200">
                  <div className="sm:py-2 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                    ...
                    <p className="text-teal-800">
                      <span role="img">🐻</span> with us, we're busy building
