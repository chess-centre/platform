...
function Members() {
  return (
      <div className="relative mt-10 sm:mt-20 py-3 sm:max-w-xl mx-auto">
        <div className="absolute inset-0  bg-teal-700 shadow-lg transform skew-y-0 sm:-rotate-6 rounded-lg"></div>
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="divide-y divide-gray-200">
              <div className="sm:py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <p>
                  <span role="img">🐻</span> with us, we're busy building your member experience!
                </p>
                <ul className="list-disc space-y-2">
                  <li className="flex items-start">
                    ...
                    <p className="ml-2">See all other members part of our Community.</p>
                  </li>
                  <li className="flex items-start">
                    <span className="h-6 flex items-center sm:h-7">
                      <svg
                    ...
                    <p className="ml-2">See results of your friends &#38; team mates.</p>
                  </li>
                  <li className="flex items-start">
                    <span className="h-6 flex items-center sm:h-7">
                      <svg
