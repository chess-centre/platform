                    ...
                    <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
                        <div className="relative">
                            <div className="prose text-gray-500 mx-auto lg:max-w-none text-justify">
                                ...
                                <p><i className="text-teal-600 fas fa-sitemap w-8"></i> 6 Rounds</p>
                                <p><i className="text-teal-600 fas fa-chess-clock w-8"></i> 25 mins per player on the clock</p>
                                <p><i className="text-teal-600 fas fa-badge-check w-8"></i> All games will be ECF rapidplay rated</p>
                                <p><i className="text-teal-600 fas fa-trophy w-8"></i> Trophies in all sections for <span className="font-semibold">top 3</span> finishers</p>
                                <p><i className="text-teal-600 fas fa-medal w-8"></i> Age category medals per section</p>
                                <p><i className="text-teal-600 fas fa-pound-sign w-8"></i> Entry fee £{defaultPrice}</p>  
                            </div>
                            ...
                            <div className="rounded-md bg-yellow-50 p-4 my-4">
                                <div className="flex">
                                    ...
                                    <div className="ml-3">
                                        <h3 className="text-sm font-medium text-yellow-800">ECF Membership Required</h3>
