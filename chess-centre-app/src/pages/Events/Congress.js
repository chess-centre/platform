          ...
          <div className="max-w-7xl mx-auto py-10 px-4 sm:py-18 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
                ...
                digitally supported congress tournament experience for our
                members and guests. Backed by our leading digital platform,
                competitors can register, track and review their participation
              ...
              <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
                Designed to accommodate modern working and social patterns, our
                “Mini-Congresses” take place over a two day weekend, with 5
                standard play rounds being played from Saturday morning to
                Sunday afternoon. Though the games are quicker than many
                congress tournaments, they are still within the parameters of
                ECF standard play events and thus are fully graded. The
                “all-play-all” format of players competing in graded groups of 6
                also ensures that players know they will receive a competitive
                and challenging test of their skills across all rounds of the
                competitions. There’s no where to hide in our “Mini-Congresses”.
              </p>
            </div>
          </div>
        </div>
