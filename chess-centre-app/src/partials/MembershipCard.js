    ...
    return (
        ...
        <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
          ...
          <div className="rounded-md shadow">
            <a href="/" className={`flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-${discounted ? "orange-600" : "teal-800"} hover:bg-${discounted ? "orange-700" : "teal-900"}" aria-describedby="tier-standard` }>
              Sign up
          </a>
          </div>
        </div>
